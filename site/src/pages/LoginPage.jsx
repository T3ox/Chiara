  ...
  return (
    <>
      <section className="section shell">
        <h1>Accedi</h1>
        <p className="lead">Area riservata in preparazione. In questa fase la pagina è un placeholder informativo.</p>
      </section>

      <section className="section shell">
        <div className="card callout-card">
          <h2>Stato attuale</h2>
          <p>La componente di autenticazione non è ancora attiva in questa release.</p>
